  ...
  return (
    <HeaderContainer>
      ...
      <Nav>
        ...
        <NavItem as={Link} to="/game" $active={isActive('/game')} aria-current={isActive('/game') ? 'page' : undefined}>Playroom</NavItem>
      ...
      {menuOpen && (
        <MobileMenu>
          ...
          <NavItem as={Link} to="/game" onClick={() => setMenuOpen(false)} $active={isActive('/game')}>Playroom</NavItem>
